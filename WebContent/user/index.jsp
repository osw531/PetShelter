			...
			<div
				...
				<div class="banner-content col-lg-8 col-md-12">
					<h1 class="text-uppercase">
						Adopt Us. <br> We need your LOVE.
					</h1>
					<p class="text-white sub-head">Lorem ipsum dolor sit amet,
						consectetur adipisicing elit, sed do eiusmod temp or incididunt ut
						labore et dolore magna aliqua. Ut enim ad minim.</p>
					<a href="#" class="primary-btn header-btn text-uppercase">Find
						a pet to adopt</a>
				</div>
			</div>
		</div>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-8">
					...
					<div class="description">
						<h4>Our mission</h4>
						<p>Aroundog는 “Happy Pet, Happy Life”라는 미션 하에 설립된 소셜벤처입니다. 국내
							반려가구는 급속도로 성장하였지만, 사전지식 부족 및 섣부른 입양결정으로 유기동물의 수도 급격히 증가하고 있습니다.
							이러한 문제점을 지속 가능한 방법으로 해결하는 것이 저희의 목표입니다.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-process">
						<span class="lnr lnr-thumbs-up"></span> <a href="#">
							<h4>공고 확인 후 문의</h4>
						</a>
						<p>홈페이지에서 보호동물 공고 확인 후 1-55-1321</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-process">
						<span class="lnr lnr-user"></span> <a href="#">
							<h4>보호 동물 면회</h4>
						</a>
						<p>방문을 통해 책임분양을 원하는 보호동물을 직접 면회</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-process">
						<span class="lnr lnr-license"></span> <a href="#">
							<h4>책임 분양 계약서 작성</h4>
						</a>
						<p>전문가를 통한 상담으로 분양에 관해 결정 한 후 책임 분양 계약서 작성</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-process">
						<span class="lnr lnr-magic-wand"></span> <a href="#">
							<h4>분양</h4>
						</a>
						<p>천사와 집으로~</p>
					</div>
